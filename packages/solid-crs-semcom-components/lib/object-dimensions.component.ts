      ...
      <div slot="content">
        <div class="dimension-field">
          ...
          <nde-form-element .actor="${this.formActor}" .translator="${this.translator}" field="heightUnit">
            <label slot="label" for="height-unit" class="invisible">${this.translator?.translate('nde.features.object.card.dimensions.field.unit')}</label>
        ...
        <div class="dimension-field">
          ...
          <nde-form-element .actor="${this.formActor}" .translator="${this.translator}" field="widthUnit">
            <label slot="label" for="width-unit" class="invisible">${this.translator?.translate('nde.features.object.card.dimensions.field.unit')}</label>
        ...
        <div class="dimension-field">
          ...
          <nde-form-element .actor="${this.formActor}" .translator="${this.translator}" field="depthUnit">
            <label slot="label" for="depth-unit" class="invisible">${this.translator?.translate('nde.features.object.card.dimensions.field.unit')}</label>
        ...
        <div class="dimension-field">
          ...
          <nde-form-element .actor="${this.formActor}" .translator="${this.translator}" field="weightUnit">
            <label slot="label" for="weight-unit" class="invisible">${this.translator?.translate('nde.features.object.card.dimensions.field.unit')}</label>
