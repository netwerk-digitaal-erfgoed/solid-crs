      ...
      <nde-card>
        ...
        <span slot='subtitle'>
          <span class='additionalType'>
            ${this.object.additionalType && this.object.additionalType[0]?.name ? this.object.additionalType[0].name :  this.translator?.translate('nde.collections.card.additionalType-unavailable')}
          </span>
          <span class='time-ago'>
