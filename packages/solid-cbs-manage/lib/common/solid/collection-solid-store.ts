import { getUrl, getSolidDataset, getStringWithLocale, getThing, getUrlAll, removeThing, saveSolidDatasetAt, fetch, getDefaultSession, setThing, removeUrl, addUrl, addStringWithLocale, createThing, overwriteFile, deleteFile, asUrl, getStringNoLocale } from '@netwerk-digitaal-erfgoed/solid-cbs-client';
import { Collection, CollectionStore, ArgumentError, fulltextMatch } from '@netwerk-digitaal-erfgoed/solid-cbs-core';
import { v4 } from 'uuid';
