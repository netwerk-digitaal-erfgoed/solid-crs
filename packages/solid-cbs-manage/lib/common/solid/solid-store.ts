import { Thing, getUrl, getSolidDataset, getThing, getThingAll, createThing, addUrl, setThing, saveSolidDatasetAt, fetch } from '@netwerk-digitaal-erfgoed/solid-cbs-client';
import { ArgumentError, Resource, Store } from '@netwerk-digitaal-erfgoed/solid-cbs-core';
import { v4 } from 'uuid';
