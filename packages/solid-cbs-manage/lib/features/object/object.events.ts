import { Event, FormSubmittedEvent } from '@netwerk-digitaal-erfgoed/solid-cbs-components';
import { CollectionObject } from '@netwerk-digitaal-erfgoed/solid-cbs-core';
