...
import { ArgumentError, Collection, CollectionObjectMemoryStore, ConsoleLogger, LoggerLevel, MemoryStore, MemoryTranslator } from '@netwerk-digitaal-erfgoed/solid-cbs-core';
