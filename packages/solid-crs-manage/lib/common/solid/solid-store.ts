import { Thing, getUrl, getSolidDataset, getThing, getThingAll, createThing, addUrl, setThing, saveSolidDatasetAt, fetch } from '@netwerk-digitaal-erfgoed/solid-crs-client';
